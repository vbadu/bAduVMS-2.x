...
class App {
    ...
    private function _define() {
		...
		if (!defined('__UPDURL__')) define('__UPDURL__', __ROOT__.'/upload'); //根上传目录
		if (!defined('__UPDDIR__')) define('__UPDDIR__', SITE_PATH.DIRECTORY_SEPARATOR.'upload'); //根上传目录
		if (!defined('__PUBDIR__')) define('__PUBDIR__', SITE_PATH.DIRECTORY_SEPARATOR.'public'); //根资源目录
